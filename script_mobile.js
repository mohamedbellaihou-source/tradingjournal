/**
 * Apex Trading Journal - Mobile Logic
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const inputs = {
        'set-app-name': settings.appName,
        'set-app-quote': settings.appQuote,
        'set-goal-target': settings.goalTarget,
        'set-goal-period': settings.goalPeriod,
        'set-default-pnl-period': settings.defaultPnlPeriod || 'all'
    };
...
function applySettings() {
    ...
    if (title) title.textContent = settings.appName;

    const quote = document.getElementById('dashboard-quote');
    if (quote) quote.textContent = settings.appQuote;
    ...
    if (pnlSelect) pnlSelect.value = settings.defaultPnlPeriod || 'all';
...
document.getElementById('trade-form').addEventListener('submit', (e) => {
    e.preventDefault();
    const confluences = Array.from(document.querySelectorAll('input[name="confluence"]:checked')).map(cb => cb.value);
    const screenshotInputs = document.querySelectorAll('input[name="screenshot"]');
    const screenshots = Array.from(screenshotInputs).map(input => input.value.trim()).filter(val => val !== '');
    ...
    if (tradeId) {
        ...
        if (index !== -1) trades[index] = { ...trades[index], ...tradeData };
    } else {
...
function updateStreak() {
    ...
    for (const t of sortedTrades) {
        ...
        if (currentStreakType === null) currentStreakType = outcome;
        if (outcome === currentStreakType) {
            if (outcome === 'W') wins++; else losses++;
        } else break;
    }
    const streakText = currentStreakType === 'W' ? `${wins} W / 0 L` : currentStreakType === 'L' ? `0 W / ${losses} L` : '0 W / 0 L';
...
function updateGoalTracker() {
    ...
    const now = new Date();
    const periodLabels = { daily: 'Daily Goal', weekly: 'Weekly Goal', monthly: 'Monthly Goal', yearly: 'Yearly Goal' };
    const headerEl = document.getElementById('goal-header');
    if (headerEl) {
        headerEl.innerHTML = `<i data-lucide="target" class="w-6 h-6 text-rose-400"></i> ${periodLabels[period] || 'Monthly Goal'} Progress`;
    }
    lucide.createIcons();
    let currentPnL = 0;
    if (period === 'daily') {
...
function updateJournalInsights(data) {
    ...
    const avgRR = winningTrades.length > 0
        ...
        : '0.00';
    const pairCounts = {};
    data.forEach(t => { pairCounts[t.pair] = (pairCounts[t.pair] || 0) + 1; });
    let topPair = '---';
    let maxCount = 0;
    ...
    const topPairEl = document.getElementById('insight-top-pair');
    if (topPairEl) topPairEl.querySelector('.text-2xl').textContent = topPair;
}
...
function renderCalendar() {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
        ...
        if (hasTrades) {
            ...
            if (dayPnL > 0) dayEl.classList.add('border-emerald-500/50', 'bg-emerald-500/10');
            else if (dayPnL < 0) dayEl.classList.add('border-rose-500/50', 'bg-rose-500/10');
            else dayEl.classList.add('border-slate-500/50', 'bg-slate-500/10');
            dayEl.innerHTML = `
...
const MOHAM_DATA = [
  { "PAIR": "XAUUSD", "Date": "July 18, 2024", "MY BIAS": "BULLISH", "BIAS MARKET": "BEARISH", "OUTCOME": "LOSS ❌", "Confluences": "BoS, Liq Sweep, OB", "PIPS": -283, "TRADE": "BUY", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK" },
  { "PAIR": "XAUUSD", "Date": "July 17, 2024", "MY BIAS": "BEARISH", "BIAS MARKET": "BEARISH", "OUTCOME": "WIN ✅️", "Confluences": "BoS, Liq Sweep, OB", "PIPS": 393, "TRADE": "SELL", "Aantal Take Profits HIT": "TP1", "SESSION": "NEW YORK" },
  { "PAIR": "XAUUSD", "Date": "July 29, 2024", "MY BIAS": "BEARISH", "BIAS MARKET": "BEARISH", "OUTCOME": "WIN ✅️", "Confluences": "BoS, Liq Sweep, OB", "PIPS": 239, "TRADE": "SELL", "Aantal Take Profits HIT": "TP1", "SESSION": "NEW YORK" },
  { "PAIR": "XAUUSD", "Date": "July 30, 2024", "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "LOSS ❌", "Confluences": "BoS, FVG, Liq Sweep, OB", "PIPS": -82, "TRADE": "BUY", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK" },
  { "PAIR": "GBPJPY", "Date": "August 5, 2024", "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "WIN ✅️", "Confluences": "BoS, Liq Sweep, OB", "PIPS": 216, "TRADE": "BUY", "Aantal Take Profits HIT": "TP1, TP2, TP3", "SESSION": "NEW YORK" },
  { "PAIR": "USDJPY", "Date": 45509, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "WIN ✅️", "Confluences": "Liq Sweep,BoS,Ob", "PIPS": 131, "TRADE": "BUY", "Aantal Take Profits HIT": "TP2", "SESSION": "NEW YORK" },
  { "PAIR": "EURUSD", "Date": 45510, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "WIN ✅️", "Confluences": "Liq Sweep,BoS,OB", "PIPS": 18, "TRADE": "BUY", "Aantal Take Profits HIT": "TP2", "SESSION": "NEW YORK" },
  { "PAIR": "USDJPY", "Date": 45510, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "WIN ✅️", "Confluences": "Liq Sweep,BoS,OB", "PIPS": 148, "TRADE": "BUY", "Aantal Take Profits HIT": "TP2", "SESSION": "NEW YORK" },
  { "PAIR": "XAUUSD", "Date": 45511, "MY BIAS": "BEARISH", "BIAS MARKET": "BEARISH", "OUTCOME": "WIN ✅️", "Confluences": "Liq Sweep,BoS,OB,FVG", "PIPS": 730, "TRADE": "SELL", "Aantal Take Profits HIT": "TP1", "SESSION": "NEW YORK" },
  { "PAIR": "GBPJPY", "Date": 45511, "MY BIAS": "BEARISH", "BIAS MARKET": "BEARISH", "OUTCOME": "WIN ✅️", "Confluences": "Liq Sweep,BoS,OB", "PIPS": 165, "TRADE": "SELL", "Aantal Take Profits HIT": "TP3", "SESSION": "NEW YORK" },
  { "PAIR": "USDJPY", "Date": 45511, "MY BIAS": "BEARISH", "BIAS MARKET": "BEARISH", "OUTCOME": "WIN ✅️", "Confluences": "Liq Sweep,BoS,OB", "PIPS": 113, "TRADE": "SELL", "Aantal Take Profits HIT": "TP3", "SESSION": "NEW YORK" },
  { "PAIR": "GBPUSD", "Date": 45523, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "WIN ✅️", "RR": 4, "Confluences": "Liq Sweep,BoS,OB", "PIPS": 25, "TRADE": "BUY", "Aantal Take Profits HIT": "TP4", "SESSION": "NEW YORK" },
  { "PAIR": "USDJPY", "Date": 45524, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "LOSS ❌", "RR": 3, "Confluences": "Liq Sweep,BoS,OB", "PIPS": -7, "TRADE": "BUY", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK" },
  { "PAIR": "EURUSD", "Date": 45525, "MY BIAS": "BEARISH", "BIAS MARKET": "BEARISH", "OUTCOME": "WIN ✅️", "RR": 2.4, "Confluences": "Liq Sweep,BoS,OB", "PIPS": 15, "TRADE": "SELL", "Aantal Take Profits HIT": "TP4", "SESSION": "NEW YORK" },
  { "PAIR": "XAUUSD", "Date": 45530, "MY BIAS": "BEARISH", "BIAS MARKET": "BEARISH", "OUTCOME": "WIN ✅️", "RR": 2, "Confluences": "Liq Sweep,BoS,OB", "PIPS": 175, "TRADE": "SELL", "Aantal Take Profits HIT": "TP1", "SESSION": "NEW YORK" },
  { "PAIR": "EURUSD", "Date": 45531, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "WIN ✅️", "RR": 3.7, "Confluences": "Liq Sweep,BoS,OB", "PIPS": 21, "TRADE": "BUY", "Aantal Take Profits HIT": "TP1", "SESSION": "NEW YORK" },
  { "PAIR": "USDJPY", "Date": 45531, "MY BIAS": "BULLISH", "BIAS MARKET": "BEARISH", "OUTCOME": "LOSS ❌", "RR": "4.2", "Confluences": "Liq Sweep,BoS,OB", "PIPS": -18, "TRADE": "BUY", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK" },
  { "PAIR": "GBPUSD", "Date": 45532, "MY BIAS": "BULLISH", "BIAS MARKET": "BEARISH", "OUTCOME": "LOSS ❌", "RR": 4.8, "Confluences": "Liq Sweep,BoS,OB", "PIPS": -8, "TRADE": "BUY", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK" },
  { "PAIR": "GBPJPY", "Date": 45532, "MY BIAS": "BEARISH", "BIAS MARKET": "BEARISH", "OUTCOME": "WIN ✅️", "RR": 3.3, "Confluences": "Liq Sweep,BoS,OB", "PIPS": 69, "TRADE": "SELL", "Aantal Take Profits HIT": "ALL", "SESSION": "NEW YORK" },
  { "PAIR": "EURUSD", "Date": 45532, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "WIN ✅️", "RR": 3, "Confluences": "Liq Sweep,Bos,EQ", "PIPS": 39, "TRADE": "BUY", "Aantal Take Profits HIT": "TP1", "SESSION": "NEW YORK" },
  { "PAIR": "XAUUSD", "Date": 45574, "MY BIAS": "BULLISH", "BIAS MARKET": "BEARISH", "OUTCOME": "LOSS ❌", "RR": 1.2, "Confluences": "Liq Sweep,BoS,OB", "PIPS": -709, "TRADE": "BUY", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK" },
  { "PAIR": "GBPJPY", "Date": 45586, "MY BIAS": "BEARISH", "BIAS MARKET": "BEARISH", "OUTCOME": "WIN ✅️", "RR": 5.3, "Confluences": "Liq Sweep,BoS,OB", "PIPS": 24, "TRADE": "SELL", "Aantal Take Profits HIT": "TP2/TP4", "SESSION": "NEW YORK" },
  { "PAIR": "GBPUSD", "Date": 45586, "MY BIAS": "BEARISH", "BIAS MARKET": "BEARISH", "OUTCOME": "LOSS ❌", "RR": 4.2, "Confluences": "Liq Sweep,BoS,OB", "PIPS": 3, "TRADE": "SELL", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK", "Reden": "Spreads" },
  { "PAIR": "GBPJPY", "Date": 45588, "MY BIAS": "BEARISH", "BIAS MARKET": "BEARISH", "OUTCOME": "WIN ✅️", "RR": 8, "Confluences": "Liq Sweep,BoS,OB", "PIPS": 19, "TRADE": "SELL", "Aantal Take Profits HIT": "TP1/TP3", "SESSION": "NEW YORK" },
  { "PAIR": "XAUUSD", "Date": 45593, "MY BIAS": "BEARISH", "BIAS MARKET": "BULLISH", "OUTCOME": "LOSS ❌", "RR": 8, "Confluences": "Liq Sweep,BoS,OB", "PIPS": 228, "TRADE": "SELL", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK" },
  { "PAIR": "GBPUSD", "Date": 45594, "MY BIAS": "BEARISH", "BIAS MARKET": "BULLISH", "OUTCOME": "LOSS ❌", "RR": 2.6, "Confluences": "Liq Sweep,BoS,OB", "PIPS": -5, "TRADE": "BUY", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK", "Reden": "Stopeed out by 1 pip" },
  { "PAIR": "USDJPY", "Date": 45594, "MY BIAS": "BEARISH", "BIAS MARKET": "BEARISH", "OUTCOME": "WIN ✅️", "RR": 4.4, "Confluences": "Liq Sweep,BoS,OB", "PIPS": 43, "TRADE": "SELL", "Aantal Take Profits HIT": "TP4/4", "SESSION": "NEW YORK" },
  { "PAIR": "USDJPY", "Date": 45596, "MY BIAS": "BEARISH", "BIAS MARKET": "BULLISH", "OUTCOME": "LOSS ❌", "RR": 3, "Confluences": "Liq Sweep,BoS,OB", "PIPS": 63.03703704, "TRADE": "SELL", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK" },
  { "PAIR": "GBPJPY", "Date": 46219, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "WIN ✅️", "RR": 3.6, "Confluences": "Liq Sweep,BoS,OB", "PIPS": 54, "TRADE": "BUY", "Aantal Take Profits HIT": "TP2/3&", "SESSION": "NEW YORK" },
  { "PAIR": "GBPJPY", "Date": 46222, "MY BIAS": "BULLISH", "BIAS MARKET": "BEARISH", "OUTCOME": "LOSS ❌", "RR": 4, "Confluences": "Liq Sweep,BoS,OB", "PIPS": -14, "TRADE": "BUY", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK" },
  { "PAIR": "USDJPY", "Date": 46223, "MY BIAS": "BULLISH", "BIAS MARKET": "BEARISH", "OUTCOME": "LOSS ❌", "RR": 5, "Confluences": "Liq Sweep,BoS,OB", "PIPS": -8, "TRADE": "BUY", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK" },
  { "PAIR": "EURUSD", "Date": 46235, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "WIN ✅️", "RR": 1.2, "Confluences": "Liq Sweep,BoS,OB", "PIPS": 13, "TRADE": "BUY", "Aantal Take Profits HIT": "TP", "SESSION": "NEW YORK" },
  { "PAIR": "EURUSD", "Date": 45838, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "LOSS ❌", "RR": 1.6, "Confluences": "Liq Sweep,BoS,OB", "PIPS": -6, "TRADE": "BUY", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK", "Reden": " SL dan gelijk TP" },
  { "PAIR": "XAUUSD", "Date": 45839, "MY BIAS": "BEARISH", "BIAS MARKET": "BULLISH", "OUTCOME": "LOSS ❌", "RR": 5.2, "Confluences": "Liq Sweep,BoS,OB", "PIPS": 296, "TRADE": "SELL", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK" },
  { "PAIR": "EURUSD", "Date": 45840, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "WIN ✅️", "RR": 3.36, "Confluences": "Liq Sweep,BoS,OB", "PIPS": 25, "TRADE": "BUY", "Aantal Take Profits HIT": "ALL/TP3", "SESSION": "NEW YORK" },
  { "PAIR": "USDJPY", "Date": 45840, "MY BIAS": "BEARISH", "BIAS MARKET": "BEARISH", "OUTCOME": "WIN ✅️", "RR": 4.87, "Confluences": "Liq Sweep,BoS,OB", "PIPS": 33, "TRADE": "SELL", "Aantal Take Profits HIT": "ALL/TP4", "SESSION": "NEW YORK" },
  { "PAIR": "GBPUSD", "Date": 45846, "MY BIAS": "BULLISH", "BIAS MARKET": "BEARISH", "OUTCOME": "LOSS ❌", "RR": 9.57, "Confluences": "Liq Sweep,BoS,OB", "PIPS": -7, "TRADE": "BUY", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK" },
  { "PAIR": "GBPUSD", "Date": 45847, "MY BIAS": "BULLISH", "BIAS MARKET": "BEARISH", "OUTCOME": "LOSS ❌", "Confluences": "Liq Sweep,BoS,OB", "TRADE": "BUY", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK" },
  { "PAIR": "GBPJPY", "Date": 45847, "MY BIAS": "BULLISH", "BIAS MARKET": "BEARISH", "OUTCOME": "WIN ✅️", "RR": 3.41, "Confluences": "Liq Sweep,BoS,OB", "PIPS": 16, "TRADE": "BUY", "Aantal Take Profits HIT": "TP1", "SESSION": "NEW YORK" },
  { "PAIR": "GBPUSD", "Date": 45848, "MY BIAS": "BULLISH", "BIAS MARKET": "BEARISH", "OUTCOME": "WIN ✅️", "RR": 5.43, "Confluences": "Liq Sweep,BoS,OB", "PIPS": -9, "TRADE": "BUY", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK", "Reden": "Spreads" },
  { "PAIR": "XAUUSD", "Date": 45848, "MY BIAS": "BEARISH", "BIAS MARKET": "BULLISH", "OUTCOME": "LOSS ❌", "RR": 1.3, "Confluences": "Liq Sweep,BoS,OB", "PIPS": -548, "TRADE": "SELL", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK", "Reden": "Niet goed strategie opgevolgd anders had ik een W" },
  { "PAIR": "EURUSD", "Date": 45852, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "LOSS ❌", "RR": 2.07, "Confluences": "Liq Sweep,BoS,OB.FVG,EQ", "PIPS": -5, "TRADE": "BUY", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK", "Reden": "No news monday + Bank holiday" },
  { "PAIR": "GBPUSD", "Date": 45852, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "LOSS ❌", "RR": 3.09, "Confluences": "Liq Sweep,BoS,OB", "PIPS": -5, "TRADE": "BUY", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK", "Reden": "No news monday + Bank holiday" },
  { "PAIR": "EURUSD", "Date": 45860, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "WIN ✅️", "RR": 3.55, "Confluences": "Liq Sweep,BoS,OB", "PIPS": 30, "TRADE": "BUY", "Aantal Take Profits HIT": "TP4/TP4", "SESSION": "NEW YORK" },
  { "PAIR": "EURUSD", "Date": 45861, "MY BIAS": "BULLISH", "BIAS MARKET": "BEARISH", "OUTCOME": "LOSS ❌", "RR": 9.5, "Confluences": "Liq Sweep,BoS,OB", "PIPS": "-1.8", "TRADE": "BUY", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK" },
  { "PAIR": "GBPUSD", "Date": 45861, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "WIN ✅️", "RR": 5.19, "Confluences": "Liq Sweep,BoS,OB", "PIPS": 14, "TRADE": "BUY", "Aantal Take Profits HIT": "TP3/TP4", "SESSION": "NEW YORK" },
  { "PAIR": "GBPUSD", "Date": 45867, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "WIN ✅️", "Confluences": "Liq Sweep,BoS,OB", "TRADE": "BUY", "SESSION": "NEW YORK" },
  { "PAIR": "XAUUSD", "Date": 45867, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "WIN ✅️", "Confluences": "Liq Sweep,BoS,OB", "TRADE": "BUY", "SESSION": "NEW YORK" },
  { "PAIR": "GBPJPY", "Date": 45992, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "WIN ✅️", "Confluences": "Liq Sweep,BoS,OB", "TRADE": "BUY", "SESSION": "NEW YORK" },
  { "PAIR": "XAUUSD", "Date": 46029, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "WIN ✅️", "RR": 6.48, "Confluences": "Liq Sweep,BoS,OB", "TRADE": "BUY", "Aantal Take Profits HIT": "TP3 dan SL BE", "SESSION": "NEW YORK", "Reden": "eerste trade van 2026, ging goed, moest wel beter optijd ready staan" },
  { "PAIR": "EURUSD", "Date": 46050, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "LOSS ❌", "RR": 2.55, "Confluences": "Liq Sweep,BoS,OB", "TRADE": "BUY", "SESSION": "NEW YORK" },
  { "PAIR": "GBPUSD", "Date": 46050, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "LOSS ❌", "RR": 2.55, "Confluences": "Liq Sweep,BoS,OB", "TRADE": "BUY", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK" },
  { "PAIR": "USDJPY", "Date": 46051, "MY BIAS": "BULLISH", "BIAS MARKET": "BULLISH", "OUTCOME": "WIN ✅️", "RR": 2.74, "Confluences": "Liq Sweep,BoS,OB", "TRADE": "BUY", "Aantal Take Profits HIT": "TP1", "SESSION": "NEW YORK", "Reden": "unemployment claims" },
  { "PAIR": "XAUUSD", "Date": "04//02/2026", "MY BIAS": "BEARISH", "BIAS MARKET": "BEARISH", "OUTCOME": "WIN ✅️", "RR": 8.95, "Confluences": "Liq Sweep,BoS,OB", "TRADE": "SELL", "Aantal Take Profits HIT": "All", "SESSION": "NEW YORK", "Reden": "in call met Karam" },
  { "PAIR": "XAUUSD", "Date": 46059, "MY BIAS": "BEARISH", "BIAS MARKET": "BEARISH", "OUTCOME": "WIN ✅️", "RR": 10.25, "Confluences": "Liq Sweep,BoS,OB", "TRADE": "SELL", "Aantal Take Profits HIT": "TP1", "SESSION": "NEW YORK", "Reden": "na jumu3a" },
  { "PAIR": "EURUSD", "Date": 46059, "MY BIAS": "BEARISH", "BIAS MARKET": "BULLISH", "OUTCOME": "WIN ✅️", "RR": 4.33, "Confluences": "Liq Sweep,BoS,OB", "TRADE": "SELL", "Aantal Take Profits HIT": "All", "SESSION": "NEW YORK" },
  { "PAIR": "GBPUSD", "Date": 46062, "MY BIAS": "BEARISH", "BIAS MARKET": "BEARISH", "OUTCOME": "WIN ✅️", "RR": 6.13, "Confluences": "Liq Sweep,BoS,OB", "TRADE": "SELL", "Aantal Take Profits HIT": "All", "SESSION": "NEW YORK" },
  { "PAIR": "GBPJPY", "Date": "08/07/2°26", "MY BIAS": "BEARISH", "BIAS MARKET": "BULLISH", "OUTCOME": "LOSS ❌", "RR": 4.59, "Confluences": "Liq Sweep,BoS,OB", "TRADE": "SELL", "SESSION": "NEW YORK", "Reden": "pre fomc" },
  { "PAIR": "XAUUSD", "Date": 46219, "MY BIAS": "BULLISH", "BIAS MARKET": "BEARISH", "OUTCOME": "LOSS ❌", "RR": 3.8, "Confluences": "Liq Sweep,BoS,OB", "TRADE": "BUY", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK" },
  { "PAIR": "XAUUSD", "Date": 46233, "MY BIAS": "BEARISH", "BIAS MARKET": "BEARISH", "OUTCOME": "LOSS ❌", "RR": 4.47, "Confluences": "Liq Sweep,BoS,OB", "TRADE": "SELL", "Aantal Take Profits HIT": "None", "SESSION": "NEW YORK", "Reden": "was market open vergeten en daardoor mijn beste entry gemist, ook heeft er een juicy drake candle van 14:30 news mijn sl gesmashed" },
  { "PAIR": "GBPUSD", "Date": 46233, "MY BIAS": "BEARISH", "BIAS MARKET": "BEARISH", "OUTCOME": "WIN ✅️", "RR": 2.64, "Confluences": "Liq Sweep,BoS,OB", "TRADE": "SELL", "Aantal Take Profits HIT": 46054, "SESSION": "NEW YORK" }
];
